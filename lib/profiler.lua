-- Taken from: https://github.com/apaszke/torch-opCounter
local M = {}
...
local function ops_convolution(module, input)
    ...
    local kernel_ops = module.kH * module.kW * input_planes * 2
    local bias_ops = 1
...
local function ops_fullconvolution(module, input)
    ...
    local single_kernel_ops = module.kH * module.kW * output_planes * 2
